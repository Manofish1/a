            ...
            case 1: { 
                ...
                do {
                    ...
                    while (!entradaValida) {
                        ...
                        // Valida a jogada (posicao dentro dos limites e vazia)
                        if (linha >= 0 && linha < 3 && coluna >= 0 && coluna < 3 && tabuleiro[linha][coluna] == ' ') {
                            entradaValida = 1; // Entrada valida
                        } else {
                ...
                } while (!jogoGanho && jogadasFeitas < 9); // Continua ate vitoria ou empate
